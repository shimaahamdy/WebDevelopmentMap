...
namespace LoginManger.Fronend
{
    ...
    public partial class site : Form
    {
        ...
        public site()
        {
            ...
            var occList = manger.GetAll().Where(R => R.CheckIn == true).ToList();
            ...
            var occList2 = manger.GetAll().Where(R => R.CheckIn == false).ToList();
        ...
        {
            var roonNumberList = manger.GetAll().Where(R => R.CheckIn == true).Select(R => R.RoomNumber.ToString().Trim()).ToList();
        ...
        private void loadResvGrid()
        {
            try
            {
                var ResLst = manger.GetAll();
                this.Grid.DataSource = ResLst;
            }
            catch (Exception)
            {
        ...
        private void ComboBoxItemsFromDataBase()
        {
            try
            {
                var R = manger.GetAll().Select(R => R).ToList();
        ...
        private void comboBox5_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                taskFinder = true;
                var resList = manger.GetAll().Where(R => R.Id == ID).ToList();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
...

            {
                ...
                var res = context.Reservations.Where(R => R.Id == primartyID).First();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                var res = manger.GetByID(primartyID);
        ...
        {
            var Results = (from R in manger.GetAll()
