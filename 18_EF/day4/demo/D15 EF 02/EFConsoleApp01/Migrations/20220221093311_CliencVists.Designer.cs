...
namespace EFConsoleApp01.Migrations
{
    ...
    [Migration("20220221093311_CliencVists")]
    partial class CliencVists
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFConsoleApp01.Entities.Clienc", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFConsoleApp01.Entities.PatientClienc", b =>
                {
                    b.Property<int>("PatientPID")
                        .HasColumnType("int");

                    b.Property<int>("CliencID")
                        .HasColumnType("int");

                    b.Property<DateTime>("Visit")
                        .HasColumnType("datetime2");

                    b.HasKey("PatientPID", "CliencID");

                    b.HasIndex("CliencID");

                    b.ToTable("PatientClienc");
                });
            ...
            modelBuilder.Entity("EFConsoleApp01.Entities.PatientClienc", b =>
                {
                    b.HasOne("EFConsoleApp01.Entities.Clienc", "Clienc")
                        .WithMany("PatientCliencs")
                        .HasForeignKey("CliencID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFConsoleApp01.Entities.Patient", "Patient")
                        .WithMany("PatientCliencs")
